...
import { Users, TrendingUp, Sparkles, PhoneCall } from "lucide-react";
...
const SUMMARY_CARDS: {
  ...
  { key: "contacted", label: "Contacted",   Icon: PhoneCall,  color: "bg-purple-500" },
  { key: "qualified", label: "Qualified",   Icon: TrendingUp, color: "bg-green-500"  },
];
