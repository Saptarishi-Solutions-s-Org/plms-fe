        ...
        >
          ...
          <div className="pointer-events-none absolute bottom-16 left-6 hidden grid-cols-4 gap-2 md:grid">
            {Array.from({ length: 16 }).map((_, index) => (
              <span key={index} className="h-1.5 w-1.5 rounded-full bg-emerald-900/12" />
            ))}
          </div>
          ...
          >
            <div>
              ...
              >
                PLMS gives organizations a structured way to capture leads,
                assign executives, track every activity, manage offers, and
                keep managers focused on what needs attention next.
              </motion.p>
            ...
            >
              ...
              {platformModules
                ...
                return (
                  ...
                  >
                    <module.icon className="mr-2 h-4 w-4" style={{ color: module.color }} />
              ...
              {platformModules.map((module, index) => (
                <Reveal key={module.label} delay={index * 0.05}>
                  <div className="group h-full rounded-2xl border border-emerald-950/10 bg-[#fbfefb] p-6 transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_55px_rgba(6,78,59,0.12)]">
                    ...
                    <h3 className="text-lg font-bold text-[#0b1713]">{module.label}</h3>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr]">
            <Reveal>
              ...
              <p className="mt-5 text-sm leading-7 text-slate-600">
                ...
                and manager reporting lines. The result is a focused workspace
                for each operating layer.
              </p>
            </Reveal>
        ...
        <section className="bg-[#0b1713] px-5 py-20 text-white md:px-8">
          <Reveal className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-white/60">
              Sign in to manage leads, update follow-ups, review offers, and
              keep the organization pipeline moving.
            </p>
            <Link
              href="/login"
